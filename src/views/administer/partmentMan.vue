    ...
    <div class="tableBox">
      <el-form :inline="true" :model="form" class="demo-form-inline">
        <el-form-item label="部门名称">
          <el-input v-model="form.bmmc" placeholder="部门名称"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog title="操作" :visible.sync="visible" width="20%">
      <el-form :model="dialogForm">
        <el-form-item label="部门名称" :label-width="formLabelWidth">
          <el-input v-model="dialogForm.bmmc" placeholder="请输入内容" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    getAllBm() {
      let param = { dwbm: localStorage.getItem("dwbm"), current: this.current };
      if (this.form.bmmc) {
