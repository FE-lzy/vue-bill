  ...
  <div class="container">
    <div class="tableBox">
      <el-form :inline="true" :model="form" class="demo-form-inline">
        <el-form-item label="员工名称">
          <el-input v-model="form.zymc" placeholder="员工名称" />
        </el-form-item>
      ...
      <el-table :data="tableData" style="width: 100%;">
        ...
        <el-table-column prop="zymc" label="员工名称" width="180" />
    ...
    <el-dialog title="操作" :visible.sync="visible" width="20%">
      <el-form ref="dialogForm" :model="dialogForm">
        ...
        >
          <el-input v-model="dialogForm.zymc" placeholder="请输入内容" autocomplete="off" />
        </el-form-item>
        <el-form-item
          label="所在部门"
          :label-width="formLabelWidth"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" :loading="isSave" @click="saveOrUpdate('dialogForm')">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    saveOrUpdate(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.isSave = true
          const param = Object.assign(this.dialogForm, dwbm)
